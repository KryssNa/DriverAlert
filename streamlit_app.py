...
# Streamlit UI
with col2:
    st.title("Driver Alertness Monitoring System!!!🥱😪😴")
    with st.container():
        ...
        with c3:
            # Lower threshold for yawning detection.
            MAR_THRESH = st.slider("Mouth Aspect Ratio threshold:", 0.0, 1.0, 0.8, 0.05)            
...
# Callbacks for video and audio processing
...
with col2:
    ctx = webrtc_streamer(
        key="driver-alertness-monitoring-system",
